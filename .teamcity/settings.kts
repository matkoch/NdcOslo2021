...
project {
    ...
    params {
        ...
        select (
            ...
            display = ParameterDisplay.NORMAL)
        password (
            "env.NUKE_ENTERPRISE_HOST",
            label = "NUKE_ENTERPRISE_HOST",
            value = "credentialsJSON:24f9009b-0fe2-443f-a1b7-7597d1746a7f",
            display = ParameterDisplay.HIDDEN)
        password (
            "env.NUKE_ENTERPRISE_TOKEN",
            label = "NUKE_ENTERPRISE_TOKEN",
            value = "credentialsJSON:59f32c60-f071-43a8-b315-403063f89304",
            display = ParameterDisplay.HIDDEN)
        text(
